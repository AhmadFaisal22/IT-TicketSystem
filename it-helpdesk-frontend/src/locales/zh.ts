export default {
  ...
  asset: {
    ...
    actions: {
      ...
      duplicate: '复制', saveAndAdd: '保存并继续添加',
    },
    quantity: '数量',
    bulkPreview: '将创建 {count} 条资产：{first} ～ {last}',
    bulkSerialHint: '批量创建时单台专属字段不可填，创建后到各资产详情页补录。',
    tagNoNumberHint: '批量创建要求资产编号以数字结尾。',
    createdOne: '已创建 {tag}。',
    createdMany: '已创建 {count} 条资产（{first} ～ {last}）。',
  },
  common: {
    save: '保存',
    cancel: '取消',
